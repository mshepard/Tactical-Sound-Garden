function onBodyLoad()
                ...
                function onDeviceReady()
                {
                    ...
                    var GetGardenSoundsURL = "http://www.tacticalsoundgarden.net/sandbox/client_getgardensounds_mobile.php";
                    ...
                    var maxSounds = 6;
                    var soundMinDistance = 1;
                    var soundMaxDistance = 10000;
                    ...
                    function createParamsPage(url, options) {
                        ...
                        $('#plantForm').submit(function() {
                                               var c = $('#cItem').val();
                                               /*var soundName = $('#sname').val();
                                               var soundVolume = $('#svolume').val();
                                               var soundInterval = $('#sinterval').val(); */
                                                $.get(PlantSoundURL,{
